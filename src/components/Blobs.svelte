...
// @ts-nocheck
  ...
  <div class="blob-container">
    {#each blobs as blob}
      <div class="blob" style="width: {blob.width}; height: {blob.width}; top: {blob.top}; left: {blob.left}; background: {blob.background}; animation-duration: {blob.animationDuration}; --start-x: {blob.startx}; --start-y: {blob.starty}; --end-x: {blob.endx}; --end-y: {blob.endy};">
      </div>
    {/each}
  </div>
