...
<div>
    ...
    I learned how to implement persistent data storage while ensuring that the game remains responsive and consistent 
    even as the player interacts with multiple systems. 
    <br/>
    This was probably the most challenging system to implement. Some objects can't be referenced directly, so I had to create 
    what felt like a convoluted system of references to ensure that the data was being saved and loaded correctly. I think a good 90% of the 
...
<PageSection>
  ...
  <h3 slot="description">Developing a full, non-buggy product takes a lot of time</h3>
  <div slot="description">
    I started this project with the assumption that this was going to be a simple one. After all, I deliberately chose 
    something simple, and at its core, it's just managing data of some plants and currency. I was aware of how much work game dev 
    actually is going into this, but all my previous experiences were very **hacky**. Sure, I could crank out a functional 
    ...
    "feature" instead of fixing it, but I couldn't be satisfied with that. Although sometimes, I think I went a bit overboard. There 
    was this one "bug" where the images on buttons wouldn't be tinted when pressed, but it worked completely fine. I ended up making a 
    custom script just to fix that. There were also so many other nit-picky things I wanted to fix, especially regarding how the 
    edit mode worked. Each tiny issue took hours to fix, but it's those **small details** that make the product feel like an actual 
    game rather than a hackathon project.
    <br />
    ...
    Aside from bugs, there were also many **tiny features** that would improve the user experience came to mind as I was developing. 
    ...
    it kind of felt like a **never-ending project**. "It would be cool if the environment changed based on the time of day" -- 
    ...
    <div class="columnContainer">
      ...
      <div class="halfColumn">
        ...
        <iframe style="min-width: 200px; width: 100%; height: 112.7vh;" 
        scrolling="yes" seamless="seamless" srcdoc='<html><body><style type="text/css">.gist .gist-data { height: 100%; }</style>
  ...
  <h3 slot="description">Learning new software will always be a bumpy road</h3>
  <div slot="description">
