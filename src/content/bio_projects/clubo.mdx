...
<SEO
  title="Jessica Sheng - Clu-Bo"
  description="Empowering children with nonverbal learning disorders in social settings - nonverbal learning disorders (NLD) make it difficult for children to understand social cues and empathize with others. Clu-Bo is a social companion that helps children with NLD strengthen their social awareness."
  openGraph={{
    basic: {
      title: "Jessica Sheng - Clu-Bo",
      type: "A type.",
...
<div class="caseStudy">
  <img src={CoverImage.src} alt="Clu-Bo" class="fullImgCover" />
...
<ProblemSolutionStatement>
  <p slot='problem'>
    NLDs are a group of disorders that impacts the ability to **interpret nonverbal cues** such as body language, 
    facial expressions, and tone. This makes it **frustrating** for children with NLD to understand social situations and communicate effectively.
  </p>
