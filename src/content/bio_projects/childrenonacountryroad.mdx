...
tags: ["art", "3d model", "illustration"]
...
import CoverImage from "../../images/childrenOnACountryRoad/Children on a Country Road.jpg";
...
<SEO
  title="Jessica Sheng - Franz Kafka: Children on a Country Road"
  description="Bringing stories to life - an illustration that seeks to capture the serenity and tranquility of Kafka's short story, Children on a Country Road."
  openGraph={{
    basic: {
      title: "Jessica Sheng - Franz Kafka: Children on a Country Road",
      type: "A type.",
...
<h1 slot="header">
  ...
  story, Children on a Country Road.
</h1>
